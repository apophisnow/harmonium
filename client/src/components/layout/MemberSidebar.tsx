...
export function MemberSidebar() {
  ...
  return (
    <div className="hidden h-full w-60 flex-col bg-[#2f3136] overflow-y-auto md:flex">
      {/* Online members */}
      {onlineMembers.length > 0 && (
        <div className="pt-6 px-4">
          <h3 className="mb-2 text-xs font-semibold uppercase text-[#96989d]">
      ...
      {members.length === 0 && (
        <div className="flex items-center justify-center p-4">
          <p className="text-sm text-[#96989d]">No members</p>
        </div>
      )}
...
function MemberItem({
  ...
  return (
    <div
      className={`flex items-center gap-3 rounded px-2 py-1.5 hover:bg-[#36393f] cursor-pointer transition-colors ${
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-1">
          <span className="truncate text-sm font-medium text-[#96989d]">
            {username}
          </span>
          {isOwner && (
